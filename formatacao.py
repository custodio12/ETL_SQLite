# Formatando os valores decimais da coluna margem_lucro, para imprimir apenas duas casas decimais
...
# Criando uma função para remover o ponto da última coluna e arredondar o valore decimal
...
with open('producao_alimentos.csv', 'r') as dados_alimentos:
    ...
    for row in reader:
        if int(row[1]) > 10:
            ...
            # # Calculando a margem de lucro e arredondando para duas casas decimais
